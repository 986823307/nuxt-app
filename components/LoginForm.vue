    ...
    <Card class="overflow-hidden p-0">
      <CardContent class="grid p-0 md:grid-cols-2">
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="grid grid-cols-3 gap-4">
              <Button variant="outline" type="button" class="w-full cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-[1rem] h-[1rem]">
                  <path
        ...
        <div class="bg-muted relative hidden md:block">
          <img
            src="/public/architecture-5585737_1280.jpg"
            alt="Image"
            class="absolute inset-0 h-full w-full object-cover dark:grayscale"
          >
        </div>
      </CardContent>
    </Card>
